...
<div class="col-md-2" style="padding: 0">
    <div class="nav_bar">
        ...
        <a href=""> <div class="nav_bar_i">用户管理</div> </a>
    </div>
</div>
...
<div class="col-md-10">
    <form id="form">
        ...
        <input type="text" name="username" placeholder="用户名" class="form-control inp_nav">
        <input type="password" name="password" placeholder="密码" class="form-control inp_nav">
        <br>
        <select name="permissions" id="permissions-selector" class="form-control">

        </select>
        <br>
        <button type="submit" class="btn btn-default" id="btn_button"">提交</button>
    ...
    <div id="list">
        <table>
            ...
            <th class="col-md-1 nav_">用户名</th>
            <th class="col-md-1 nav_">用户属性</th>
            <th class="col-md-1 opt nav_">操作</th>
            <th class="col-md-1 opt nav_">操作</th>
            </thead>
