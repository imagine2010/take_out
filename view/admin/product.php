...
<div class="col-md-10">
    <form id="form">
        ...
        <input type="text" name="title" placeholder="名称" class="form-control inp_nav">
        <input type="text" name="prop" placeholder="说明" class="form-control inp_nav">
        <br>
        <input type="text" name="sales" placeholder="销量" class="form-control inp_tit">
        <input type="text" name="price" placeholder="价格" class="form-control inp_tit">
        <input type="file" name="cover" placeholder="产品图" id="exampleInputFile" class="file_inp">
        <select name="cat_id" id="cat_id" class="form-control">
        </select>
        <button id="btn_button" type="submit" class="btn btn-default">提交</button>
    </form>

    <select name="" id="show_rule" class="form-control">
    ...
    <div id="list">
        <table>
            ...
            <th class="col-md-1 nav_">价格</th>
            <th class="col-md-1 nav_">分类</th>
            <th class="col-md-1 nav_">图片</th>
